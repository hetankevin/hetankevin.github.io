...
ninja.data = [{
    ...
    handler: () => {
      window.location.href = "/al-folio/";
        ...
        section: 'Socials',
        handler: () => {
          window.open("mailto:%6B%65%76%74%61%6E@%77%68%61%72%74%6F%6E.%75%70%65%6E%6E.%65%64%75", "_blank");
        },
      },{
        id: 'social-github',
        title: 'GitHub',
        section: 'Socials',
        handler: () => {
          window.open("https://github.com/hetankevin", "_blank");
        },
      },{
        id: 'social-linkedin',
        title: 'LinkedIn',
        section: 'Socials',
        handler: () => {
          window.open("https://www.linkedin.com/in/hetankevin", "_blank");
        },
      },{
        id: 'social-orcid',
        title: 'ORCID',
        section: 'Socials',
        handler: () => {
          window.open("https://orcid.org/0009-0004-9844-5135", "_blank");
        },
      },{
        id: 'social-scholar',
        ...
        section: 'Socials',
        handler: () => {
          window.open("https://scholar.google.com/citations?user=LJUS_7IAAAAJ", "_blank");
        },
      },{
      id: 'light-theme',
